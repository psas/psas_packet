...
Message({
    ...
    'members': [
        ...
        {'key': "TOW",                  'stype': "Q",   'units': {'mks': "second", "scaleby": 100}},
        {'key': "Latitude",             'stype': "q",   'units': {'mks': "degree", "scaleby": 1.0e7}},
        {'key': "Longitude",            'stype': "q",   'units': {'mks': "degree", "scaleby": 1.0e7}},
        {'key': "Ellipsoid_Altitude",   'stype': "Q" ,  'units': {'mks': "meter",  "scaleby": 100}},
        {'key': "MSL_Altitude",         'stype': "Q" ,  'units': {'mks': "meter",  "scaleby": 100}},
        {'key': "GDOP",                 'stype': "L" ,  'units': {'mks': "",       "scaleby": 100}},
        {'key': "PDOP",                 'stype': "L" ,  'units': {'mks': "",       "scaleby": 100}},
        {'key': "HDOP",                 'stype': "L" ,  'units': {'mks': "",       "scaleby": 100}},
        {'key': "VDOP",                 'stype': "L" ,  'units': {'mks': "",       "scaleby": 100}},
        {'key': "TDOP",                 'stype': "L" ,  'units': {'mks': "",       "scaleby": 100}},
        {'key': "ECEF_X",               'stype': "q" ,  'units': {'mks': "meter",  "scaleby": 100}},
        {'key': "ECEF_Y",               'stype': "q" ,  'units': {'mks': "meter",  "scaleby": 100}},
        {'key': "ECEF_Z",               'stype': "q" ,  'units': {'mks': "meter",  "scaleby": 100}},
        {'key': "ECEF_VX",              'stype': "q" ,  'units': {'mks': "m/s",    "scaleby": 100}},
        {'key': "ECEF_VY",              'stype': "q" ,  'units': {'mks': "m/s",    "scaleby": 100}},
        {'key': "ECEF_VZ",              'stype': "q" ,  'units': {'mks': "m/s",    "scaleby": 100}},
    ]
}),
Message({
    'name': "Version",
